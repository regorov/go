...
func updateEditRamDialogs() {
	editRamDialog.SetTitle("Edit RAM " + currentlyEditingRam.Name)
	...
	editRamNameDialog.SetTitle("Edit RAM " + currentlyEditingRam.Name)
	editRamNameDialog.SetValue(currentlyEditingRam.Name)

	editRamWidthDialog.SetTitle("Edit RAM " + currentlyEditingRam.Name)
	editRamWidthDialog.SetValue(strconv.FormatUint(uint64(currentlyEditingRam.Width), 10))

	editRamDepthDialog.SetTitle("Edit RAM " + currentlyEditingRam.Name)
