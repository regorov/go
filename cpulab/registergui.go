...
func addRegisterToGui(register *Register) {
	...
	addMoveMicroInstructionDialog.AddOption(&termdialog.Option{"Use " + asMicroRegister.String() + " as source operand", addMoveMicroInstructionDestinationCallback, asMicroSource})

	asMicroDestination := IMicroDestination(asMicroRegister)
	addMoveMicroInstructionDestinationDialog.AddOption(&termdialog.Option{"Use " + asMicroRegister.String() + " as destination operand", addMoveMicroInstructionCallback, asMicroDestination})
}
